...
/**
 * Các type bên dưới không được đảm bảo là các giá trị cụ thể của programModeEnumMap.
 * Sửa đổi `programModeEnumMap` làm sao để các type bên dưới có type cụ thể là các value của programModeEnumMap.
 * example: GroupProgram có type là 'group',...
 */
